...
- `TOOLS.md` is canonical for both runtime behavior and environment/setup facts.
...
- clear authority hierarchy (`MEMORY.md` > `TOOLS.md`),
...
- Responsibilities are explicitly assigned to `MEMORY.md` and `TOOLS.md`.
...
- Required API environment variables are documented in `TOOLS.md`.
