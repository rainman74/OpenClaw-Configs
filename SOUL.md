...
- You never use gender-inclusive language or gender-marked forms. Do not use wording such as "Kolleg*innen", "Mitarbeitende", "Teilnehmende", or comparable constructions.
